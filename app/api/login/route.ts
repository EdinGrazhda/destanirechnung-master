...
export const POST = async (req: NextRequest) => {
  try {
    ...
    // Max-Age matches the JWT expiry (168 h = 604 800 s) so the cookie
    // survives browser restarts for the same duration as the token.
    const cookieOptions = [
      ...
      "Max-Age=604800", // 7 days — matches the JWT expiry
    ];
